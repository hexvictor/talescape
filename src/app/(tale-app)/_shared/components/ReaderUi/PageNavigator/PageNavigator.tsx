				...
				{open && navigatorVisibility.expanded ? (
					...
					>
						<div
							...
							className="overflow-hidden rounded-lg border border-white/12 bg-black/92 shadow-2xl backdrop-blur-xl"
						>
							<PageNavigatorGrid
								key={currentPage.id}
				...
				{!navigatorVisibility.expanded ? (
					...
					>
						...
						<div
							...
							className="flex items-end gap-1.5 rounded-t-lg border border-white/12 border-b-0 bg-black/82 p-1.5 shadow-2xl backdrop-blur-md"
						>
							<button
								data-reader-component="PageNavigator"
