...
export default function ModalWrapper({ children }: ModalWrapperProps) {
	...
	return (
		<div
			className={`modal pointer-events-auto ${isCentered ? "relative" : "-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2"} flex h-auto ${fitContent ? "" : "max-h-[500px] w-[80%] max-w-[500px]"} items-center justify-center ${rounded ? "rounded-[12px]" : ""} border-none bg-transparent font-medium text-2xl`}
