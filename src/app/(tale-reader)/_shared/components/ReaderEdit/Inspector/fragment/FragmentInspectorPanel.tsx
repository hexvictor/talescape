...
import { useInspectorEditingState } from "../../../../hooks/store/useReaderEditorSelectors";
import { editFragment } from "../../../../services/readerEdits";
import type { ResolvedTaleFragment, TaleFragment } from "../../../../types";
import { DebugTabs } from "../../../ReaderUi/TaleDebug/DebugPrimitives";
import {
