...
function Badge({
	...
	return (
		<span
			className={`inline-flex items-center rounded-full border px-2 py-1 font-semibold text-[10px] leading-none shadow-sm sm:text-xs ${className}`}
		>
			{children}
		</span>
	);
...
const ReaderBlockDebugBadges = React.memo(ReaderBlockDebugBadgesComponent);
export default ReaderBlockDebugBadges;
