  ...
  return (
    <div
      className={clsx(
        "pointer-events-auto ",
        isReel && !isVertical
          ? "-translate-x-1/2 absolute bottom-0 left-1/2 z-100 hidden pb-4 md:flex md:flex-col"
          : "-translate-y-1/2 absolute top-1/2 right-0 z-100 hidden pr-4 md:flex",
                      ...
                      onClick={() => {
                        ...
                        if (previousEntry) {
                          requestAnimationFrame(() =>
                            navigateToAnchor(previousEntry.id, {
                              type: "entry",
                            })
                          );
                        }
                    ...
                    <TooltipTrigger asChild>
                      ...
                      >
                        <Button
                          ...
                          onClick={() =>
                            navigateToAnchor(entry.id, { type: "entry" })
                          }
                  ...
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (nextEntry) {
                          requestAnimationFrame(() =>
                            navigateToAnchor(nextEntry.id, { type: "entry" })
                          );
                        }
                      }}
                    >
